  ...
  return (
    <div className="w-123.75 gap-6 h-68 border border-[#D7DBE3] rounded-2xl py-6.25 px-6.25 flex flex-col items-center ">
      <div className="w-full flex items-center justify-between ">
        <span className="text-xs font-bold">دانشگاه علوم و تحقیقات</span>
      ...
      <div className="w-full flex items-center justify-between ">
        ...
        <span className="text-xs font-normal ">حقوق کیفری</span>
      </div>
      <div className="w-full flex items-center justify-between ">
        <span className="text-xs font-normal text-[#6D7278]">سال تحصیلی</span>
        <span className="text-xs font-normal ">1398-1402</span>
      </div>
      <div className="w-full flex items-center justify-end gap-5">
        <button className="flex items-center justify-between gap-1 rounded-2xl px-3.5 py-1 bg-[#FFECEC] text-xs text-[#D32F2F]">
